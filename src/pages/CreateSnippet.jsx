      ...
      <div className="bg-linear-to-r from-indigo-600 to-purple-600 text-white py-8 px-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-gray border bg-opacity-20 p-2 rounded-lg">
              <Code2 className="h-6 w-6" />
            </div>
            <div>
              <h1 className="text-2xl font-bold">Create New Snippet</h1>
              <p className="text-indigo-100 text-sm mt-1">
                Save a reusable piece of code to your vault
              </p>
            </div>
          </div>
          <button
            onClick={() => navigate('/dashboard')}
            className="flex items-center gap-2 bg-gray bg-opacity-20 hover:bg-opacity-30 px-4 py-2 rounded-lg transition border"
          >
            <X className="h-5 w-5" />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <select
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition text-gray-800 ${
                    errors.language ? 'border-red-400 bg-red-50' : 'border-gray-300'
                  }`}
                >
              ...
              <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4">
                ...
                <p className="text-xs text-indigo-600">
                  Use descriptive titles and tags to make your snippets easy to find later.
                </p>
              </div>
            </div>
          </div>
